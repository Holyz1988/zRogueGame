...
int main()
{
	std::string query = "CREATE TABLE IF NOT EXISTS Player (idPlayer INTEGER PRIMARY KEY, maxHP INT, attackDamage INT, level INT, currency INT, bulletRadius INT, bulletDelay FLOAT)";
